...
void MulticastConfigurator::initialize(int stage)
{
    ...
    if (stage == INITSTAGE_LOCAL) {
        ...
        std::cerr << "[MulticastConfigurator] INSTANTIATED on: " << getFullPath() << std::endl;
        std::cerr << "  groupAddress='" << groupAddress << "' inInterface='" << inInterface 
                  << "' outInterfaces='" << outInterfaces << "'" << std::endl;
        ...
        std::cerr << "[MulticastConfigurator] INITSTAGE_NETWORK_LAYER on " << getFullPath() << std::endl;
...
void MulticastConfigurator::addMulticastRoute()
{
    ...
    if (groupAddress.empty()) {
        std::cerr << "[MulticastConfigurator] ERROR: groupAddress is empty – NOT installing route!" << std::endl;
    ...
    std::cerr << "[MulticastConfigurator] Installing route: group=" << group << " inIface=" 
              << inInterface << " outIfaces=" << outInterfaces << std::endl;
    ...
    std::cerr << "[MulticastConfigurator] SUCCESS: Route installed on " << host->getFullPath() 
              << " – routing table now has " << rt->getNumMulticastRoutes() << " routes" << std::endl;
